...
const BlogsNew = () => {
        ...
        const fetchBlogs = async () => {
            try {
                const response = await client.getEntries({
                    ...
                    limit: 9, // Show more blogs on dedicated page
                    order: '-sys.createdAt'
                })
    ...
    if (loading) {
        return (
            <section id="blog" className="py-16 px-4 md:px-8 lg:px-16 bg-[#FFF8F4] ">
                <div className="max-w-7xl mx-auto">
                    {/* Centered loading for tag */}
                    <div className="flex justify-center mb-8">
                        <div className="h-10 bg-gray-200 rounded-full w-20 animate-pulse"></div>
                    </div>
                    {/* Centered loading for heading */}
                    <div className="flex justify-center mb-16">
                        <div className="h-20 bg-gray-200 rounded w-96 animate-pulse"></div>
                    </div>
    ...
    return (
        <section className="py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16 bg-[#FFF8F4]">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Centered Header Section - No Explore Button */}
                <div className="text-center mb-12 md:mb-16 lg:mb-20">
                    <h2
                        className="text-[#1B0C25] text-4xl md:text-5xl lg:text-[69px] font-semibold leading-tight lg:leading-[74px] font-sans "
